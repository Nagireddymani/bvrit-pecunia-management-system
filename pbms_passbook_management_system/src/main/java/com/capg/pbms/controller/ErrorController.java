...
public class ErrorController {
	...
	public ErrorResponse handleInvalidDatesException(HttpServletRequest req)
	{
		return new ErrorResponse(new Date(),"Invalid Period ", HttpStatus.BAD_REQUEST.getReasonPhrase(), HttpStatus.BAD_REQUEST.value(), req.getRequestURI());
	}
}
