...
public class DebitUsingChequePage extends Library{

	public DebitUsingChequePage(WebDriver driver) {
	...
	@FindBy(xpath = "/html/body/app-root/body/app-trasaction/div/div/div[2]/div/div[2]/div[2]/button")
	WebElement debitButton;
	
	@FindBy(id = "accountNum")
	WebElement accountNumText;
	...
	@FindBy(xpath = "/html/body/app-root/body/app-trasaction/div/div/div[2]/div[2]/form/div[8]/div/button")
	WebElement submitButton;
	
	public void goToDebitFormPage()
	{
	...
	{
		accountNumText.sendKeys(accountNum);
	}
